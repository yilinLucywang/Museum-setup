...
public class AudioPosTriggerDataGUI : GUIDraggableObject {
	public GUIStyle style;

	public AudioPosTriggerData trigger;
	public Texture2D eventTexture;

	public Rect drawRect;

	public AudioPosTriggerDataGUI(AudioPosTriggerData trigger){
	...
	public void CalculateGUIPosition(float zoomFactor, float hScrollPosition, Rect guiRect, AudioClip clip){
		float pointx = ACEEditorData.CalculateGUIAudioPosition(zoomFactor, hScrollPosition, guiRect, clip, trigger.audioPos);
	...
	public float CalculateAudioPosition(float zoomFactor, float hScrollPosition, Rect guiRect, AudioClip clip){
		float pos = ACEEditorData.CalculateAudioPosition(zoomFactor, hScrollPosition, guiRect, clip, m_Position.x);
